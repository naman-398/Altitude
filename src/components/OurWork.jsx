    ...
    return (
        <div className='bg-rich-black relative'>
            <div className='max-w-[1194px] mx-auto px-3 py-32 relative'>
                ...
                <div className='flex lg:flex-col md:flex-col flex-row-reverse justify-center md:justify-start xl:items-center  gap-6 md:gap-[55px] lg:gap-[52px] sm:max-w-[415px] max-w-[380px] xxs:max-w-[400px]  md:max-w-[768px] mx-auto lg:max-w-[unset] lg:mx-0'>
                    ...
                    <div className='flex lg:flex-col md:flex-row flex-col justify-center md:justify-start xl:items-center gap-6 md:gap-[55px] lg:gap-[52px] '>
                        ...
                        <div className='flex items-center flex-col lg:flex-row gap-4 md:gap-12 xl:justify-start justify-center order-2'>
                            {secondSet.map((card, index) => (
